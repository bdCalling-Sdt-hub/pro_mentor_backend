...
const socketIO = (io) => {
    ...
    io.use((socket, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const decoded = yield (0, socketVerifyToken_1.socketVerifyToken)(tokenValue, config_1.default.jwt_access_secret); // Ensures secret is a string
    ...
    io.on('connection', (socket) => {
        ...
        try {
            ...
            if (!((_a = socket === null || socket === void 0 ? void 0 : socket.decodedToken) === null || _a === void 0 ? void 0 : _a.userId)) {
                console.error('No user ID in decoded token');
                return;
            }
            if (!activeUsers[socket.decodedToken.userId]) {
                activeUsers[socket.decodedToken.userId] = Object.assign(Object.assign({}, socket.decodedToken), { id: socket.decodedToken.userId });
                console.log(`User Id: ${socket.decodedToken.userId} has connected.`);
            }
            else {
                console.log(`User Id: ${socket.decodedToken.userId} is already connected.`);
            }
