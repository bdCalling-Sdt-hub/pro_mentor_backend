...
const getAllWithdrawRequestAccept = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // give me validation data
    const result = yield withdraw_service_1.withdrawService.acceptSingleWithdrawService(req.params.id);
    if (result) {
        (0, sendResponse_1.default)(res, {
            statusCode: http_status_1.default.OK,
            success: true,
