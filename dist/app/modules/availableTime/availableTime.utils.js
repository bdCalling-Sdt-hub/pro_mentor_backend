...
exports.generateSlotsForDays = void 0;
...
const generateSlotsForDays = (startTime, endTime) => {
    ...
    while (start < end) {
        ...
        start.setMinutes(start.getMinutes() + 30); // increment by 30-minute intervals
    }
    return slots;
};
exports.generateSlotsForDays = generateSlotsForDays;
